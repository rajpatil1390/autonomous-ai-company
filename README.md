...
every claim in this README can be verified by cloning the repo and running
the commands in [Quick start](#quick-start). It was **not** built by hand,
...
- **I reviewed and ran** the resulting tests, benchmarks, and infrastructure
  assets, and verified the numbers reported below are real, not aspirational.

I'm stating this openly because directing AI coding agents effectively —
architecture-first, spec-driven, test-verified — is itself a real skill, and
one directly relevant to agentic AI development work. I'd rather be evaluated
on that honestly than have it discovered later.

**Depth varies by module.** I can walk through the agent design, the
LangGraph orchestration, the LLM abstraction layer, and the testing strategy
in real depth — that's where my direct involvement was deepest. The
infrastructure-as-code, observability, chaos-engineering, and disaster-
recovery assets are included as reference implementations generated with AI
...
Helm, Terraform, pytest, and Ruff — developed with Claude and Codex as AI
coding partners, directed and reviewed by the author. Their maintainers and
communities make this reference architecture possible.
